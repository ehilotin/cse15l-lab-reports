...
It's a relatively simple fix for something that might be a very confusing bug, since the code is conceptually correct. On line 43 of `ListExamples.java`, `index1 += 1;` should be changed to `index2 += 1;`.
